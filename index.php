...
<body>
    <header>
        <div class="d-flex align-items-center mb-2">
            <img class="logo-google" src="https://loghi-famosi.com/wp-content/uploads/2020/09/Google-Logo.png" alt="logo-img">
            <span class="img-span">Privacy e termini</span>
        </div>
        <div class="links border">
            <span class="link" tabindex="0">Introduzione</span>
            <span class="link" tabindex="0">Norme sulla privacy</span>
            <span class="link" tabindex="0">Termini di servizio</span>
            <span class="link" tabindex="0">Tecnologie</span>
            <span class="link" tabindex="0">Domande frequenti</span>
        </div>
    </header>
    <main class="container">
        <?php 
            foreach($questions_answers as $el){ ?>
                <section>
                    <h1><?php echo $el['question'] ?></h1>
